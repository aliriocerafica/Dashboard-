  ...
  const handleStatusUpdate = async (requestId: string, newStatus: string) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setEmailMessage(`Email sent to ${request.email} - Status updated to ${newStatus}`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">IT Asset Requests Management</h1>
          <p className="text-gray-600">Review and manage all IT asset requests with email notifications</p>
        </div>
        ...
        <div className="mt-8 bg-blue-50 rounded-2xl border border-blue-200 p-6">
          ...
          <ul className="text-sm text-blue-800 space-y-2">
            ...
            <li>• Automatic emails are sent to the requester with status updates</li>
