    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        <div className="text-center">
          <div className="w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl flex items-center justify-center text-white shadow-lg mx-auto mb-4 sm:mb-6">
            <CurrencyDollarIcon className="w-8 h-8 sm:w-12 sm:h-12" />
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-lg border border-gray-700 p-6 sm:p-12 max-w-2xl mx-auto">
            <div className="text-center mb-4 sm:mb-6">
              ...
              <p className="text-sm sm:text-base text-gray-400 mb-4 sm:mb-6">
                The Finance dashboard is currently under development. This will
                include:
              </p>
            </div>
